...
from app.utilitarios.emailUtilitario import dispararEmailComTentativas, corpoEmailRelatorio
...
async def contasPagarCsv(
    ...
    conteudo = service.contasPagarCsv(empresaId, usuario.id, mes, ano)
...
async def contasReceberCsv(
    ...
    conteudo = service.contasReceberCsv(empresaId, usuario.id, mes, ano)
