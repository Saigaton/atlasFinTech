...
class RelatorioService:
    ...
    def contasPagarCsv(self, empresa_id: int, usuario_id: int, mes: int | None = None, ano: int | None = None) -> bytes:
    ...
    def contasReceberCsv(self, empresa_id: int, usuario_id: int, mes: int | None = None, ano: int | None = None) -> bytes:
    ...
    def backupZip(self, empresa_id: int, usuario_id: int) -> bytes:
        ...
        with zipfile.ZipFile(buf, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            zf.writestr("contas_a_pagar.csv",  self.contasPagarCsv(empresa_id, usuario_id))
            zf.writestr("contas_a_receber.csv", self.contasReceberCsv(empresa_id, usuario_id))
        return buf.getvalue()
